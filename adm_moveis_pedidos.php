...
<head>
    ...
    <title>ADMINISTRAÇÃO | Móveis Pedidos</title>
</head>
<body>
    ...
    <main id="main_home">
        ...
        <main id="main_conteudo_principal">
            <header class="header_conteudo_principal">
                    <h2>Móveis Pedidos</h2>
                    <!--  FORMULÁRIO PARA PODER FAZER A BUSCA  -->
                    <form action="adm_moveis_pedidos.php" id='pesquisa_pedidos' method="post" autocomplete="off">
                    ...
                    <?php
                        ...
                        if(isset($_POST['bnt_buscar'])){
                            ...
                            if($buscar == 'aberto'){
                                ...
                                INNER JOIN Moveis M ON M.movel_id = P.pedido_referencia ORDER BY pedido_id DESC";
                                ...
                                //  PEDIDO FEITO RECENTEMENTE PELO CLIENTE
                                    if($status == 0){
                                        ...
                                        echo        "</div>";
                                        echo        "<div>";
                                        echo            "<p>Móvel referência:</p>";
                                        echo            "<span>".$referencia."</span>";
                                        echo        "</div>";
                                        echo        "<div>";
